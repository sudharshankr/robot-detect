...
class Decrypt:
    def __init__(self, pms_hex, client_r, server_r):
        ...
        self.client_random = bytes.fromhex(client_r)
        self.server_random = bytes.fromhex(server_r)
        self.master_secret = ""
    ...
    def decrypt_app_data(self, side, data):
...
#     dec = Decrypt(a, "6844f918ef23051e59f00834e4f251a0675d0f831c26cb214a4c404214bad614",
#                   "5e999839c5fc1f0726046b43a1f2c8ee23c0ac2ab95769a085f4ad2235a30206")
